...
dep = "QB6_6 Total 'Agree'"

## - FIRST TRY TO FIX NONLINEARITY - It causes to many outliers. - ##
'''
formula = (
...
'''
## - SECOND TRY TO FIX NONLINEARITY - ##
formula = (
    f'Q("{dep}") ~ Q("Bachelor or equivalent") + Q("Master or equivalent") + Q("Doctoral or equivalent")'
    f' + I(Q("Bachelor or equivalent")**2) + I(Q("Master or equivalent")**2) + I(Q("Doctoral or equivalent")**2)'
    f' + I(Q("Bachelor or equivalent")**3) + I(Q("Master or equivalent")**3) + I(Q("Doctoral or equivalent")**3)'
    f' + Q("Bachelor or equivalent")*Q("Master or equivalent")'
    f' + Q("Bachelor or equivalent")*Q("Doctoral or equivalent")'
    f' + Q("Master or equivalent")*Q("Doctoral or equivalent")'
)
